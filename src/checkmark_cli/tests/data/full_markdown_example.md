...
URLs and URLs in angle brackets will automatically get turned into links.
[[[http://www.example.com](http://www.example.com)](http://www.example.com)]([http://www.example.com](http://www.example.com)) or [[[http://www.example.com](http://www.example.com)](http://www.example.com)]([http://www.example.com](http://www.example.com)) and sometimes
example.com (but not on Github, for example).
